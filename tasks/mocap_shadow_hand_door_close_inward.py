...
class MocapShadowHandDoorCloseInward(BaseTask):
    """
    ...
    def compute_full_state(self, asymm_obs=False):
        ...
        # self.obs_buf[:, obj_obs_start :obj_obs_start + 3] = self.door_right_handle_goal_pos
        # self.obs_buf[:, obj_obs_start + 3 :obj_obs_start + 7] = self.door_right_handle_goal_rot
        # self.obs_buf[:, obj_obs_start + 7 :obj_obs_start + 10] = self.door_left_handle_goal_pos
        # self.obs_buf[:, obj_obs_start + 10 :obj_obs_start + 14] = self.door_left_handle_goal_rot
    ...
    def compute_point_cloud_observation(self, collect_demonstration=False):
        ...
        self.obs_buf[:, obj_obs_start :obj_obs_start + 3] = self.door_right_handle_pos
        self.obs_buf[:, obj_obs_start + 3 :obj_obs_start + 7] = self.right_hand_rot
        self.obs_buf[:, obj_obs_start + 7 :obj_obs_start + 10] = self.door_left_handle_pos
        self.obs_buf[:, obj_obs_start + 10 :obj_obs_start + 14] = self.left_hand_rot
